import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`pages-flow-screens-design-export`,title:`Reference/Pages/Flows/Flow Screens`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Composite raster of payment flow screens on desktop.</p>
<h4 class="de-variant">desktop-default</h4>
<div class="de-grid de-grid--screen">
<figure class="de-item">
  <img class="de-img de-img--screen" src="/designs/screens/flow-screens/variants/desktop-default/default.png" alt="desktop-default / default" loading="lazy" />
