import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`components-selection-control-radio-button-design-export`,title:`Reference/Components/Selection Control/Radio Button`,tags:[`!autodocs`],parameters:{layout:`padded`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Selection control for choosing one option in a mutually exclusive group.</p>
...
<figure class="de-item">
  <img class="de-img" src="/designs/components/selection-control/radio-button/variants/regular-active/hover.svg" alt="regular-active / hover" loading="lazy" />
