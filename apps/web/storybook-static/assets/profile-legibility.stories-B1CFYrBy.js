import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`pages-profile-legibility-design-export`,title:`Reference/Pages/Profile/Legibility`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Profile settings tab: Legibility / scaling.</p>
<h4 class="de-variant">default-default</h4>
<div class="de-grid de-grid--screen">
<figure class="de-item">
  <img class="de-img de-img--screen" src="/designs/screens/profile-legibility/variants/default-default/default.svg" alt="default-default / default" loading="lazy" />
