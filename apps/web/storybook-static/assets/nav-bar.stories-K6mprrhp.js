import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`components-nav-bar-design-export`,title:`Reference/Components/Nav Bar`,tags:[`!autodocs`],parameters:{layout:`padded`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Top navigation bar with back and close actions.</p>
<h4 class="de-variant">default-default</h4>
<div class="de-grid">
<figure class="de-item">
  <img class="de-img" src="/designs/components/nav-bar/variants/default-default/default.svg" alt="default-default / default" loading="lazy" />
