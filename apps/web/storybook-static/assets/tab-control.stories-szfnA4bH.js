import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`components-tab-control-design-export`,title:`Reference/Components/Tab Control`,tags:[`!autodocs`],parameters:{layout:`padded`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Tab control for switching between related panels such as RGB and HSL inputs.</p>
<h4 class="de-variant">default-default</h4>
<div class="de-grid">
<figure class="de-item">
  <img class="de-img" src="/designs/components/tab-control/variants/default-default/default.svg" alt="default-default / default" loading="lazy" />
