import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`components-list-item-row-item-design-export`,title:`Reference/Components/List Item/Row Item`,tags:[`!autodocs`],parameters:{layout:`padded`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Row items (e.g. bookings, headers).</p>
...
<figure class="de-item">
  <img class="de-img" src="/designs/components/list-item/row-item/variants/default-booking/hover.svg" alt="default-booking / hover" loading="lazy" />
