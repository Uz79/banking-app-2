import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`pages-payment-flow-type-ahead-search-active-design-export`,title:`Reference/Pages/Payment Flow/Type Ahead Search Active`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Payment flow step: type-ahead search field active.</p>
<h4 class="de-variant">mobile-default</h4>
<div class="de-grid de-grid--screen">
<figure class="de-item">
  <img class="de-img de-img--screen" src="/designs/screens/payment-flow-type-ahead-search-active/variants/mobile-default/default.svg" alt="mobile-default / default" loading="lazy" />
