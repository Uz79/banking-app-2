import{n as e}from"./chunk-DnJy8xQt.js";var t,n,r;e((()=>{t={title:`Live/Components/List item`,parameters:{docs:{description:{component:`Hover and press list rows to preview the state overlay (Tier A surfaces).`}}}},n={name:`State layer (hover / press)`,render:()=>`
  ...
  \`
}`,...n.parameters?.docs?.source}}},r=[`InteractiveStateLayer`]}))();export{n as InteractiveStateLayer,r as __namedExportsOrder,t as default};