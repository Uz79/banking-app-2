import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`components-menu-menu-details-more-functions-design-export`,title:`Reference/Components/Menu/Menu Details More Functions`,tags:[`!autodocs`],parameters:{layout:`padded`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Contextual “More functions” menu from Overview / Account details action row (bottom sheet mobile, anchored dialog desktop).</p>
<h4 class="de-variant">default-default</h4>
<div class="de-grid">
<figure class="de-item">
  <img class="de-img" src="/designs/components/menu/menu-details-more-functions/variants/default-default/default.svg" alt="default-default / default" loading="lazy" />
