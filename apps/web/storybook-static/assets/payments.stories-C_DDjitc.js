import{n as e}from"./chunk-DnJy8xQt.js";var t,n;e((()=>{t={id:`pages-payments-design-export`,title:`Reference/Pages/Payments`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{disable:!0}}},n={name:`Design export`,render:()=>`
    <style>
    ...
    <div class="de-wrap">
      <p class="de-desc">Payments landing (before multi-step payment flow).</p>
<h4 class="de-variant">desktop-default</h4>
<div class="de-grid de-grid--screen">
<figure class="de-item">
  <img class="de-img de-img--screen" src="/designs/screens/payments/variants/desktop-default/default.svg" alt="desktop-default / default" loading="lazy" />
...
<div class="de-grid de-grid--screen">
<figure class="de-item">
  <img class="de-img de-img--screen" src="/designs/screens/payments/variants/mobile-default/default.svg" alt="mobile-default / default" loading="lazy" />
