...
// Source: designs/components/selection-control/radio-button/radio-button.json

export default {
  id: "components-selection-control-radio-button-design-export",
  title: "Reference/Components/Selection Control/Radio Button",
  tags: ['!autodocs'],
  parameters: {
    layout: "padded",
    docs: { disable: true },
