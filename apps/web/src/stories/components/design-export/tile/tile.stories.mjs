...
// Source: designs/components/tile/tile.json

export default {
  id: "components-tile-design-export",
  title: "Reference/Components/Tile",
  tags: ['!autodocs'],
  parameters: {
    layout: "padded",
    docs: { disable: true },
...
export const DesignExport = {
  ...
  render: () => `
    ...
    <div class="de-wrap">
      <p class="de-desc">Compact content tile with label, primary name, and secondary detail line (e.g. IBAN).</p>
<h4 class="de-variant">default</h4>
<div class="de-grid">
<figure class="de-item">
  <img class="de-img" src="/designs/components/tile/variants/default/default.svg" alt="default / default" loading="lazy" />
  <figcaption class="de-cap">default / default</figcaption>
</figure>
</div>
<h4 class="de-variant">selected</h4>
<div class="de-grid">
<figure class="de-item">
  <img class="de-img" src="/designs/components/tile/variants/selected/default.svg" alt="selected / default" loading="lazy" />
  <figcaption class="de-cap">selected / default</figcaption>
</figure>
</div>
    </div>
  `,
