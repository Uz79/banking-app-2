/** Markup for Live/Pages/Account Details (carousel, bookings, payment-details overlay). */

export const PAYMENT_DETAILS_OVERLAY = `
...
export function accountDetailsLiveMarkup() {
  return `
    <div class="app">
      <aside class="sidebar">
    ...
    ${PAYMENT_DETAILS_OVERLAY}
  `;
}

export const ACCOUNT_DETAILS_LIVE_SCRIPTS = [
  'payment-state.js',
  'data-render.js',
