...
// Source: designs/screens/investment-product-details/investment-product-details.json

export default {
  id: "pages-investment-product-details-design-export",
  title: "Reference/Pages/Investment Product Details",
  tags: ['!autodocs'],
  parameters: {
    layout: "fullscreen",
    docs: { disable: true },
