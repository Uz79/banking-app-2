...
// Source: designs/screens/payment-flow-summary/payment-flow-summary.json

export default {
  id: "pages-payment-flow-summary-design-export",
  title: "Reference/Pages/Payment Flow/Summary",
  tags: ['!autodocs'],
  parameters: {
    layout: "fullscreen",
    docs: { disable: true },
